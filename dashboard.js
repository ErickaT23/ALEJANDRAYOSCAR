...
const guestDirectorySeed = {
    "1": { nombre: "Sofía Morales", pases: 2 },
    "2": { nombre: "Daniel Ramírez", pases: 2 },
    "3": { nombre: "Valeria Castillo", pases: 1 },
    "4": { nombre: "Familia Hernández", pases: 4 },
    "5": { nombre: "Javier Mendoza", pases: 2 }
};

const guestDirectoriesByEvent = {
    "oscar-alejandra-2027": guestDirectorySeed
};
...
function resolveDashboardEventContext() {
    ...
    const defaultEventId = String(eventConfig.defaultEventId || "oscar-alejandra-2027").trim() || "oscar-alejandra-2027";
